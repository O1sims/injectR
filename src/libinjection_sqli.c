...
int libinjection_sqli(const char** input, int *slen, int *b, char** fin0, char** fin1, char** fin2, char** fin3, char** fin4, char** fin5, char** fin6, char** fin7)
{
    const char* snew = *input;
    size_t length = *slen;
    ...
    libinjection_sqli_init(&state, snew, length, 0);
